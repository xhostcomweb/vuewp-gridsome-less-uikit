<template>
  <Layout>
    <h1 class="title is-2 is-light is-semibold is-spaced main-title" v-html="$page.wordPressPost.title"/>
    <img
    ...
    />
    <div class="has-text-light" v-html="$page.wordPressPost.content"/>
    <template v-if="$page.wordPressPost.categories.length">
      <h4 class="title is-4 is-light is-semibold is-spaced" >Posted in</h4>
    ...
    <template v-if="$page.wordPressPost.tags.length">
      <h4 class="title is-4 is-light is-semibold is-spaced">Tags</h4>
      <ul class="list tags">
